...
interface PlaylistState {
  ...
  activeView: "listen-now" | "radio" | "charts" | "favorites" | "search" | "playlist-detail" | "lyrics" | "album" | "artist" | "profile" | "settings";
  searchQuery: string;

  // Actions
  setActiveView: (view: "listen-now" | "radio" | "charts" | "favorites" | "search" | "playlist-detail" | "lyrics" | "album" | "artist" | "profile" | "settings", resourceId?: string) => void;
